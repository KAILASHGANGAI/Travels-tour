<div class="container my-5">
    ...
    <p class="text-center mb-5">Explore our latest articles and stay updated with the newest trends and insights.</p>
    
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="{{ asset('web/images/pasupati.jpg') }}" class="card-img-top" alt="Blog Title 1">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="{{ asset('web/images/pasupati.jpg') }}" class="card-img-top" alt="Blog Title 2">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="{{ asset('web/images/pasupati.jpg') }}" class="card-img-top" alt="Blog Title 3">
                <div class="card-body">
