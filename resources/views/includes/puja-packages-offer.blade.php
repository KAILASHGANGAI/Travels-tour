<div class="container my-5">
    <h2 class="section-title">Best Puja Package offers for You</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="package-card">
                ...
                <img src="{{ asset('web/images/pooja/rudrabhishek.jpg') }}" alt="Lotus Delhi">
        ...
        <div class="col-md-3">
            <div class="package-card">
                ...
                <img src="{{ asset('web/images/pooja/Vastu-Shanti-Puja.webp') }}" alt="Burj Khalifa">
                <div class="package-details">
                    <p>Included: Air ticket, Hotel, Breakfast, Tours, Airport Transfer</p>
                    <div class="details-icons">
                        <span><i class="fa fa-heart"></i> 86415</span>
        ...
        <div class="col-md-3">
            <div class="package-card">
                ...
                <img src="{{ asset('web/images/pooja/rudrabhishek.jpg') }}" alt="Pyramids Egypt">
                <div class="package-details">
                    <p>Included: Air ticket, Hotel, Breakfast, Tours, Airport Transfer</p>
                    <div class="details-icons">
                        <span><i class="fa fa-heart"></i> 86415</span>
        ...
        <div class="col-md-3">
            <div class="package-card">
                ...
                <img src="{{ asset('web/images/pooja/Vastu-Shanti-Puja.webp') }}" alt="Mountain Vietnam">
                <div class="package-details">
                    <p>Included: Air ticket, Hotel, Breakfast, Tours, Airport Transfer</p>
                    <div class="details-icons">
                        <span><i class="fa fa-heart"></i> 86415</span>
