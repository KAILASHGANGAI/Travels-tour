<div class="container mt-5">
    ...
    <div class="row">
        <!-- Tour Cards Section -->
        <div class="col-md-8">
            <h1 class="text-center my-4">Puja Lists Of Different Hotels & Lodges</h1>

            <div class="tour-card">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="{{ asset('web/images/hotesl/1.avif') }}" alt="India Spiritual Tour with Taj Mahal">
                    </div>
                    <div class="col-md-8">
            ...
            <div class="tour-card">
                <div class="row no-gutters">
                    <div class="col-md-4">
                        <img src="{{ asset('web/images/hotesl/1.avif') }}" class="h-100" alt="India Spiritual Tour with Taj Mahal">
                    </div>
                    <div class="col-md-8">
                        <div class="tour-info d-flex">
                            <div class="pt-2 p">
