...
<style>
     .banner {
        ...
        .bg {
            background: url('{{ asset('web/images/nepal/martin-skrivanek-fdvv0CiL3ck-unsplash.jpg') }}') no-repeat center center/cover;
...
<section class="py-3 py-md-5 py-xl-8 bg">
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          <h2 class="mb-5 pt-5 text-white display-5 text-center">Need Help</h2>
          <p class="text-white mb-2 text-center lead fs-4">Our team is available to provide prompt and helpful responses to all inquiries. You can reach us via phone, email, or by filling out the contact form below.</p>
          ...
          <div class="card border border-dark rounded shadow-sm overflow-hidden">
            <div class="card-body p-0">
              <div class="row gy-3 gy-md-4 gy-lg-0">
                ...
                background:  linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8)),url('{{ asset('web/images/nepal/manuel-meurisse-RlXU6DiifBg-unsplash.jpg') }}') no-repeat center center;
                  ...
                  <div class="row align-items-lg-center justify-content-center h-100">
                    <div class="col-11 col-xl-10">
                      <div class="contact-info-wrapper py-4 py-xl-5">
                        <h5 class="h1 mb-3 text-light">Get in touch</h5>
                        ...
                        <div class="d-flex mb-4 mb-xxl-5">
                          ...
                          <div>
                            <h6 class="mb-2 text-light">Address</h6>
                        ...
                        <div class="row mb-4 mb-xxl-5">
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-4 mb-xxl-0">
                              ...
                              <div>
                                <h6 class="mb-2 text-light">Phone</h6>
                                <p class="mb-0">
                          ...
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-0">
                              ...
                              <div>
                                <h6 class="mb-2 text-light">E-Mail</h6>
                                <p class="mb-0">
                        ...
                        <div class="d-flex">
                          ...
                          <div>
                            <h6 class="mb-2 text-light">Opening Hours</h6>
